# Contribuindo com o TabelaKanban

Obrigado pelo interesse. Antes de abrir um PR de código, dá uma olhada no
`README.md` pra entender as decisões já tomadas (board = pasta, coluna =
subpasta, card = arquivo `.md` — nada de metadado separado, mover um card é
mover um arquivo).
